            ...
            <div className="relative z-10">
                ...
                <section className="container mx-auto px-3 sm:px-6 py-10 sm:py-16">
                    <div className="max-w-6xl mx-auto">
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8">API Endpoints</h3>

                        <div className="space-y-6 sm:space-y-8">
                            {endpoints.map((endpoint, index) => (
                                <div key={endpoint.id} className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 overflow-hidden">
                                    {/* Endpoint Header */}
                ...
                <section className="container mx-auto px-3 sm:px-6 py-10 sm:py-16">
                    <div className="max-w-4xl mx-auto">
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8">Available Categories</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <section className="container mx-auto px-3 sm:px-6 py-10 sm:py-16">
                    <div className="max-w-4xl mx-auto">
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8">Code Examples</h3>
                ...
                <section className="container mx-auto px-3 sm:px-6 py-10 sm:py-16">
                    <div className="max-w-4xl mx-auto">
                        <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8">Error Handling</h3>
